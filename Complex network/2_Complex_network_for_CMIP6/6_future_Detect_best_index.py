...
input_base_dir1="/public/home/fcai/abc/2Paper_blocking/CMIP6_data/2x2/SSP585_U300/"
...
for model in model_name:
    ...
    pattern1=os.path.join(input_base_dir1,f"2x2_300_JA-ua_{model}_ssp585_2015-2100_NH.nc"); print(pattern1)
    ...
    ua = u.sel(time=ds1['time'].dt.year.isin(range(2064,2099+1))) ;print( ua)
    ...
    ## ------------- b. complex network
    ds0=xr.open_dataset(f"/public/home/fcai/abc/2Paper_blocking/CMIP6_data/complex_network/4_SSP585_U300positive_network/significant/{model}_U300Positive_significant_99.nc")
    ...
    ds1=xr.open_dataset(f"/public/home/fcai/abc/2Paper_blocking/CMIP6_data/complex_network/5_SSP585_U300negative_network/significant/{model}_U300Negative_significant_99.nc")
...
tripole = xr.DataArray(data= Model_triple_index, dims=['Model','year','lat','lon'],
            coords= {'Model':range(20),'year': np.arange(2064,2099+1), 'lat':range(12,68+2,2),'lon':range(0,358+2,2)})

ds3 = xr.Dataset(data_vars= dict(tripole = tripole))
ds3.to_netcdf("/public/home/fcai/abc/2Paper_blocking/CMIP6_data/complex_network/6_pattern/standize_future_Model_tripole_wind_index_based_on_automatic_finding.nc")
ds3.close()
exit()

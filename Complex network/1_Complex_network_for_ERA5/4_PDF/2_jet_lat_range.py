...
for ilat in range(0,45+11):
    networks0[ilat,:,:,:] = np.where((((ilat-11)*2+1)>=0) & (((ilat-11)*2+1)<=30),networks0[ilat,:,:,:] , 0.0)
...
# # ---------------------------- calculate pdf ---------------------------- # #
# # four grid for one to save memory
pdf = np.zeros((21,41))
...
ds3.to_netcdf("/public/home/fcai/abc/2Paper_jet/Fig2/Fig2_new/3_U300negative_network/PDF/0_30_PDF_U300_negative.nc")
ds3.close()

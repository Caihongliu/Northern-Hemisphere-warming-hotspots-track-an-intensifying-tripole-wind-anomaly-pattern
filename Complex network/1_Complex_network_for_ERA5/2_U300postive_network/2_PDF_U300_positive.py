...
# for ilat in range(-11,45):
#     networks0[ilat+11,:,:,:] = np.where(((ilat*2+1)>=30) ,networks0[ilat+11,:,:,:] , 0.0)
...
ds3.to_netcdf("/public/home/fcai/abc/2Paper_jet/Fig2/Fig2_new/2_U300positive_network/PDF_U300_postive.nc")
ds3.close()